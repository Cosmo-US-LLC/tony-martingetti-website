export const SUCCESS_STORY_FILTERS = [
  "All Stories",
  "Consulting",
  "Program Growth",
  "Education",
...
export const SUCCESS_STATS = [
  { value: "$150M+", label: "In bequests secured for clients" },
  { value: "29+", label: "Years of proven results" },
  { value: "$2.2M", label: "Single member success story" },
];
...
export const TESTIMONIALS = [
  ...
  },
  {
    id: "frank-pannizzo",
    quote:
      "I had tried to make a substantial gift to my alma mater, but it was frustrating — until Tony started working with them. He listened, understood my goals, and worked with my attorney to fashion a gift instrument to meet my needs. Purposeful, comfortable, and fulfilling.",
    name: "Frank J. Pannizzo, Esq.",
    role: "Donor, New York City",
    category: "Education",
  },
  {
    id: "patricia-nolan",
    quote:
      "Your newsletter continues to inspire me. The 'one hour a day' rule is so true — we all need to focus on what is truly important in the development process: reaching out. Thank you for all you're doing for our profession.",
    name: "Patricia D. Nolan",
    role: "Major Gift Officer, St. John's University",
    category: "Program Growth",
  },
  {
    id: "accelerator-member",
    quote:
      "I appreciate that Tony makes Planned Giving clear and simple by breaking things down into manageable pieces every week. His approach takes the intimidation out of a topic that so many nonprofits avoid.",
    name: "Planned Giving Accelerator Member",
  ...
  },
  {
    id: "attorney-nyc",
    quote:
      "Tony's familiarity with the institution's needs, his knowledge of tax laws, and his ability to work as part of a team were critical in achieving the goals of both the donor and the institution. My client was anxious to give — Tony made it happen.",
    name: "Attorney",
    role: "New York City",
    category: "Consulting",
  },
  ...
  },
  {
    id: "susan-braun",
    quote:
      "We are truly appreciative for everything Tony has done on behalf of this school. His expertise and discipline have been gifts to our organization.",
    name: "Susan Braun",
  ...
  },
  {
    id: "regular-listener",
    quote:
      "I love the mix of authors, nonprofit CEOs, and philanthropists on this podcast. Tony doesn't shy away from tough questions. I always come away having learned something. He has a fun-loving approach to a topic that's too often branded as boring.",
