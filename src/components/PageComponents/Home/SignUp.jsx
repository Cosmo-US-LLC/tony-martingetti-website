...
export default function SignUp() {
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1320px] flex-col gap-12 md:gap-20">
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between md:gap-20">
          <div className="flex flex-col gap-3 md:max-w-[664px] md:gap-3">
            ...
            <p className="text-base leading-[22.4px] tracking-[-0.16px] text-[#c6c6c6]">
              Join the list, get your free chapter today, and be first in
              line when the book launches this September.
            </p>
          </div>
          ...
          <div className="flex w-full flex-col items-stretch gap-3 sm:w-auto sm:flex-row sm:items-center">
            <a
              ...
              className="cursor-pointer rounded-lg bg-[#059669] px-6 py-3 text-center text-base font-bold leading-6 text-white"
            >
              Order Now
            </a>
            <a
