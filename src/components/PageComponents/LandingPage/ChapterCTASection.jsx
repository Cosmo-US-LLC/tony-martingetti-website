    ...
    <section className="w-full bg-[#0A1730] py-14 md:py-[60px]" data-name="Start With Chapter 1. Free">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center gap-10 px-4 md:px-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <h2 className="text-[24px] font-bold leading-[28.8px] tracking-[-0.48px] text-white md:text-[40px] md:leading-[48px] md:tracking-[-0.8px]">
            Start With Chapter 1. Free
          </h2>
          <p className="max-w-[540px] text-base leading-[22.4px] tracking-[-0.16px] text-white">
            Planned Giving Accelerated isn&apos;t published yet. Joining the
            waitlist costs nothing and gets you reading today.
          </p>
        </div>

        <div className="flex w-fit max-w-[600px] flex-col gap-6 rounded-2xl bg-white/[0.04] p-6 md:p-8">
            ...
            {WAITLIST_BENEFITS.map((benefit) => (
              <li key={benefit.title} className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-base font-semibold leading-[22.4px] text-white">
                    {benefit.title}
                  </span>
                  <span className="text-sm leading-[19.6px] text-[#C6C6C6]">
                    {benefit.description}
                  </span>
                </div>
              </li>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between text-base font-semibold leading-[22.4px] text-white">
          ...
          >
            <label className="sr-only" htmlFor="landing-cta-name">
              Name
            </label>
            <input
              id="landing-cta-name"
          ...
          <p className="text-xs leading-[14.4px] text-[#FAFAFA]/80">
