    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1280px] flex-col px-4 md:px-8">
        <div className="flex w-full max-w-[680px] flex-col gap-5">
          ...
          <p className="text-base leading-[26px] text-white md:text-[18px] md:leading-[25.2px] md:tracking-[-0.5px]">
            ...
            <ul className="flex flex-col gap-3">
              {BENEFITS.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  ...
                  <span className="text-base font-semibold leading-[22.4px] tracking-[-0.16px] text-white">
                    {item}
                  </span>
                </li>
              ))}
