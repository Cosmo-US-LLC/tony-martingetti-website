  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
  className="relative flex w-full max-w-[890px] flex-col items-center text-center gap-6 md:items-start md:text-left"
  data-name="Container"
>
  ...
  <div
    className="flex w-full flex-col items-center text-center gap-0 md:items-start md:text-left"
