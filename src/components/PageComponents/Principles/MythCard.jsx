...
export default function MythCard({ number, myth, reality, icon: Icon }) {
  return (
    <article
      className="group flex cursor-default flex-col gap-[30px] rounded-xl border border-gray-200 md:border-transparent bg-white px-6 py-[30px] shadow-[0px_3px_3px_rgba(37,37,37,0.07)] transition-[border-color,box-shadow] hover:border-[#0e7159] hover:shadow-[0px_3px_3px_rgba(37,37,37,0.15)]"
    >
