import HERO_BG from "@/assets/images/about/hero-bg.webp";
...
export default function AboutHero() {
  return (
    <section className="relative -mt-[100px] w-full overflow-hidden bg-[#21021b]">
      ...
      <div className="relative flex min-h-[660px] w-full flex-col px-4 pt-[250px] pb-5 md:min-h-[770px] md:px-[60px] md:pt-[202px] md:pb-0">
