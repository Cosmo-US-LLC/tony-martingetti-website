...
export default function Navbar() {
  ...
  return (
    <header
      className={[
        "font-landing sticky top-0 z-50 h-[100px] w-full px-4 backdrop-blur-[24px] md:px-[60px]",
        isLight
    ...
    >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  ...
                  isActive
                    ? "rounded-[2px] border border-[#079669] px-2 py-1.5 font-semibold text-[#079669]"
                    : isLight
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          />
          <div className="absolute right-0 top-0 flex h-full w-[288px] flex-col justify-between bg-white p-4 shadow-xl">
